<?php
    ...
    $cssPagina = ["doador/tela-de-cartoes.css"];
    ...
    <div class="principal">
        ...
        <div class="container-white">
            ...
            <div class="cartoes-container" >
                ...
                <!-- Botão Adicionar -->
                <div  class="adicionar-cartao" onclick="abrir_popup('popup-adicionar-cartao')">
...
<!-- Popup de confirmação de exclusão bem-sucedida -->
