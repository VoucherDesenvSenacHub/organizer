        ...
        <form id="form" class="dados-ong" action="../../../controller/Ong/EditarPerfilController.php" method="POST"
            ...
            <fieldset>
                ...
                <div class="form-foto-perfil">
                    ...
                    <div class="foto-preview" id="fotoPreview" style="display: none;">
                        <img id="previewImage" src="<?= !empty($perfil['foto'])
                            ? $perfil['foto']
                            : '../../assets/images/global/image-placeholder.svg' ?>">

                        <button type="button" class="btn-remover-foto" id="btnRemoverFoto">
            ...
            <fieldset>
                ...
                <div class="form">
                    ...
                    <label><span>Email</span><input name="email" type="text" required
                            value="<?= $perfil['email'] ?>"></label>
                </div>
            ...
            <fieldset>
                ...
                <div class="form">
                    ...
                    <label><span>Rua</span><input name="rua" id="rua" type="text" required readonly
                            value="<?= $perfil['rua'] ?>"></label>
                    <label class="label-short"><span>Nº</span><input name="numero" id="numero" type="text" required
                            value="<?= $perfil['numero'] ?>"></label>
                    ...
                    <label class="label-short"><span>Estado</span><input id="estado" name="estado" type="text" required
                            value="<?= $perfil['estado'] ?>"></label>
                </div>
            </fieldset>
                ...
                <div class="form">
                    ...
                    <label>
                        ...
                        <select name="tipo_conta">
                            <option value="POUPANÇA" <?= ($perfil['tipo_conta'] === 'POUPANÇA') ? 'selected' : '' ?>>
                                Poupança</option>
                            <option value="CORRENTE" <?= ($perfil['tipo_conta'] === 'CORRENTE') ? 'selected' : '' ?>>
                                Corrente</option>
                        </select>
                    </label>
                </div>
            ...
            <div class="btn-acoes">
                ...
                <button class="btn" type="button" onclick="inativarOng()">INATIVAR MINHA ONG <i
