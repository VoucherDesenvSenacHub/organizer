                ...
                <?php foreach ($voluntarios as $voluntario) { ?>
                    <tr class="linha-coluna">
                        <td class="logo-empresa">
                            ...
                            <h1><?php echo $voluntario['nome'] ?> <br>
...
<div class="tela-solicitacao-voluntario" id="tela-solicitacao-voluntario">
    <div class="card-solicitacao-voluntario">
        <div class="texto-solicitacao">
            <form action="">
                <textarea name=""
                    id="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur qui quasi accusamus ipsa inventore deserunt perspiciatis unde dolorum reiciendis officia? Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur qui quasi accusamus ipsa </textarea>
            </form>
        </div>
        <div class="img-usuario-solicitacao">
            ...
            <div class="div-btns">
                <button class="aceitar" id="aceitar"><span><img src="../../assets/images/aceitar.png" alt=""></span>
                    Aceitar</button>
                <button class="recusar" id="recusar"><span><img src="../../assets/images/recusar.png"
                            alt=""></span>Recusar</button>
            </div>
        </div>
    </div>
</div>
