...
$cssPagina = ["ADM/perfil-ong-adm.css"]; //Colocar o arquivo .css (exemplo: 'ONG/cadastro.css')
...
<div id="principal">
        ...
        <div class="baixo2">
            <div class="voluntario">
                ...
                <div class="lista_voluntarios">
                    <div class="nomes">
                        <img src="../../assets/images/logovoluntario.webp">
    ...
    <?php
    $jsPagina = ['../global/main.js']; //Colocar o arquivo .js (exemplo: 'cadastro.js')
