            ...
            <div class="escolha">
                <div class="item">
                    ...
                    <div>
                        ...
                        <form onsubmit="return confirm('Confirmar sua escolha como Doador?')" action="../../../controller/Usuario/PrimeiroAcessoUsuarioController.php" method="POST">
                ...
                <div class="item">
                    ...
                    <div>
                        ...
                        <form onsubmit="return confirm('Confirmar sua escolha como Organização?')" action="../../../controller/Usuario/PrimeiroAcessoUsuarioController.php" method="POST">
